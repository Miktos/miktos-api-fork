"""
Simple test for Gemini function calling in a terminal-created file
"""
...
@pytest.mark.asyncio
async def test_function_calling_final():
    ...
    # Set up function call that has the proper attributes
    class MockFunctionCall:
        def __init__(self):
            self.name = "get_weather"
            self.args = {"location": "New York"}
